...
|--------|------|----------|------|
| **CLANGTIDY** | C++ 静态分析 | 高 | ⭐⭐⭐⭐⭐ |
| **RAWTHROW** | 禁止直接 `throw` | 低 | ⭐⭐⭐⭐ |
| **INCLUDE** | `#include` 格式检查 | 低 | ⭐⭐⭐ |
| **C10_UNUSED** | 检查已弃用宏 | 低 | ⭐⭐⭐ |
| **C10_NODISCARD** | 检查已弃用宏 | 低 | ⭐⭐⭐ |
...
| 第三批 (C++实践) | ✅ 完成 | 2026-03-31 | 2026-03-31 |
| 第四批 (构建系统) | ⏳ 待开始 | - | - |
| 第五批 (测试相关) | ⏳ 待开始 | - | - |

**验证记录**：
- 2026-03-31: 第三批迁移后验证发现 Ascend/pytorch 存在 lint 问题
  - CLANGFORMAT: 配置文件错误已修复
  - SPACES: 尾部空格问题
  - INCLUDE: #include 格式问题
  - PYFMT: Python 格式化问题
